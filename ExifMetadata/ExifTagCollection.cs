...
namespace LevDan.Exif
{
    public sealed class ExifTagCollection : IEnumerable<ExifTag>
    {
        ...
        public ExifTagCollection(string fileName, bool useEmbeddedColorManagement, bool validateImageData)
        {
            ...
            {
                Image image = Image.FromStream(stream, useEmbeddedColorManagement, validateImageData);
    ...
    public sealed class AllExifTagCollection : IEnumerable<ExifTag>
    {
        private Dictionary<int, ExifTag> _tags;

        #region Constructors
        public AllExifTagCollection(string fileName) : this(fileName, true, false)
        {
        }

        public AllExifTagCollection(string fileName, bool useEmbeddedColorManagement, bool validateImageData)
        {
            using (FileStream stream = new FileStream(fileName, FileMode.Open, FileAccess.Read))
            {
                Image image = Image.FromStream(stream, useEmbeddedColorManagement, validateImageData);
        ...
        public AllExifTagCollection(Image image)
        {
            ReadTags(image.PropertyItems);
        }
        #endregion
        ...
        {
            Encoding ascii = Encoding.ASCII;
            SupportedAllEXIFTags supportedTags = new SupportedAllEXIFTags();
            _tags = new Dictionary<int, ExifTag>();
    ...
    public sealed class ExifGPSLatLonTagCollection : IEnumerable<ExifTag>
    {
        private Dictionary<int, ExifTag> _tags;

        #region Constructors
        public ExifGPSLatLonTagCollection(string fileName) : this(fileName, true, false)
        {
        }

        public ExifGPSLatLonTagCollection(string fileName, bool useEmbeddedColorManagement, bool validateImageData)
        {
            using (FileStream stream = new FileStream(fileName, FileMode.Open, FileAccess.Read))
            {
                Image image = Image.FromStream(stream, useEmbeddedColorManagement, validateImageData);
        ...
        public ExifGPSLatLonTagCollection(Image image)
        {
            ReadTags(image.PropertyItems);
        }
        #endregion
        ...
        {
            Encoding ascii = Encoding.ASCII;
            GPSLatLonTags supportedTags = new GPSLatLonTags();
            _tags = new Dictionary<int, ExifTag>();
    ...
    internal sealed class SupportedGPSTags : Hashtable
    {
        public SupportedGPSTags()
        {
            this.Add(0x0, new ExifTag(0x0, "GPSVersionID", "GPS tag version"));
            this.Add(0x5, new ExifTag(0x5, "GPSAltitudeRef", "Altitude reference"));
            this.Add(0xA40C, new ExifTag(0xA40C, "SubjectDistanceRange", "Subject distance range"));
    ...
    internal sealed class GPSLatLonTags : Hashtable
    {
    ...
    internal sealed class SupportedAllEXIFTags : Hashtable
    {
        public SupportedAllEXIFTags()
        {
            this.Add(0x10E, new ExifTag(0x10E, "ImageDescription", "Image title"));//*
            this.Add(0x9003, new ExifTag(0x9003, "DateTimeOriginal", "Date and time of original data generation"));//*
            this.Add(0x132, new ExifTag(0x132, "DateTime", "File change date and time"));//*
